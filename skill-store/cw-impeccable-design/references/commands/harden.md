...
- Set minimum readable sizes (16px body on mobile is the floor; 14px only for genuinely secondary text. iOS Safari force-zooms focused inputs under 16px, which breaks form layouts)
...
- Network issues, large datasets, concurrent actions
- Empty states, errors, permission states
