export const enUS = {
  ...
  app: {
    ...
    // App toast messages
    resetDatabaseFailed: 'Failed to reset database, please refresh the page manually',
    localDataCleared: 'Local data cleared, you can start fresh',
    clearFailedCloseOtherTabs: 'Failed to clear: please close other tabs/windows of this app first and retry',
    ...
    projectCreatedButSwitchFailed: 'Project created but failed to switch, please try manually',
    ...
    databaseHandleInvalidExplanation: 'After browser tab hibernation, the database file handle becomes invalid. This is normal browser behavior.',
    ifJustClearedData: 'If you just executed "Clear Data", please close other tabs/windows of the same origin first, then refresh the current page.',
    yourDataIsSafe: 'Your conversation data is safe!',
    dataStoredInOPFS: 'Data is stored in browser OPFS, just temporarily inaccessible.',
    willAutoRecoverAfterRefresh: 'Database connection will automatically recover after page refresh.',
    refreshPage: 'Refresh Page',
    cannotCloseDialog: 'This dialog cannot be closed - please click the button above to refresh the page',
    // Storage loading screen
    databaseInitFailed: 'Database initialization failed',
    databaseResetExplanation: 'This may be due to database corruption or migration failure. Resetting the database will clear all data and recreate.',
  ...
  settings: {
    ...
    syncPanel: {
      ...
      encryptionNotice: 'Your session data is encrypted before uploading. The server only stores encrypted data and cannot access your original content.',
      ...
      confirmDelete: 'Are you sure you want to delete this synced session? This cannot be undone.',
      crossDeviceSync: 'Cross-device Sync',
      syncDescription: 'Sync current session to cloud, or download session from cloud. Supports end-to-end encryption, only encrypted data is stored.',
      loading: 'Loading...',
      close: 'Close',
      ...
      conflictResolution: {
        ...
        keepNativeDescription: 'Keep original version in filesystem, discard OPFS changes',
        ...
        binaryFilePreview: '[{source} version is an image or binary file, text preview not supported]',
        noReadableContent: '[{source} version has no readable text content]',
        emptyFile: '[{source} version is empty file]',
        contentTruncated: '...[Content too long, truncated {charCount} characters]',
        whyConflict: 'Why did this conflict happen?',
        conflictExplanation: 'The file in OPFS was also modified in the local filesystem. The system detected that the modification times of the two versions are different, and you need to decide which version to keep.',
        ifKeepNativeExists: 'Choosing "Keep Native Version" will discard changes in OPFS.',
        ifKeepNativeNotExists: 'Native file does not exist. If you choose "Keep Native Version", this file will be deleted.',
        skipThisConflict: 'Skip This Conflict',
        applySelection: 'Apply Selection',
        nativeNotConnected: '[Native directory not connected, cannot read native version]',
      },

      // Sync Preview Panel (Empty State)
      syncPreview: {
        emptyStateTitle: 'Changes Pending Review',
        emptyStateDescription: 'File system changes detected after executing Python code will appear here. You can preview the details and then approve or reject these changes.',
      ...
      fileChangeList: {
        ...
        noChangesDescription: 'No file system changes detected after Python execution',
        added: 'Added',
        modified: 'Modified',
        deleted: 'Deleted',
      ...
      fileDiffViewer: {
        ...
        selectFileHint: 'Select a file from the list on the left to view diff between version and current file',
        ...
        binaryContent: 'Binary content does not support text-level diff. Download the file or use a dedicated binary comparison tool.',
        ...
        imageWillBeDeleted: 'Image will be deleted (no content in changed version)',
        currentFileComments: 'Current file comments',
        close: 'Close',
        // AI review prompt
        reviewPromptIntro: 'Please review the following file snapshot and provide modification suggestions:',
        file: 'File',
        ...
        conversationRunning: 'Current conversation is running, please try again later',
        reviewConversation: 'Change Review',
        // Error messages
        loadFailedError: 'Failed to load file',
        cannotReadNativeContent: 'Cannot read native file content. Please select a project directory first.',
    ...
    pendingSyncPanel: {
      ...
      confirmRejectMessage: 'Are you sure you want to reject all changes? This cannot be undone.',
      cancel: 'Cancel',
      confirmReject: 'Confirm Rejection',
      reviewSuccess: 'Review successful!',
      rejectedAllSuccess: 'All changes rejected',
      rejectedCountWithFailure: 'Rejected {successCount} changes, {failedCount} kept in list due to missing local file baseline',
      ...
      conflictDetectFailed: 'Conflict detection failed, continuing with approval',
      ...
      conversationRunningPleaseWait: 'Current conversation is running, please try again later',
    ...
    toast: {
      ...
      providerNameRequired: 'Please enter provider name, Base URL and model name',
    ...
    modelSelection: {
      ...
      customModelHint: 'Enable to enter any model name, suitable for newly released models',
    },
    ...
    maxIterationsHint: 'Limit the maximum assistant turns in a single Agent Loop',
  ...
  welcome: {
    ...
    apiKeyRequiredHint: 'Please configure API Key in model settings first to start',
  ...
  skillEditor: {
    ...
    instructionPlaceholder: 'You are a code review expert. When user asks to review code:\n1. Analyze type safety\n2. Check for performance issues\n3. Evaluate readability',
    exampleDialog: 'Example Dialog',
    exampleDialogPlaceholder: 'User: "Help me review this component"\nAI: "Let me check..."',
    exampleDialogHelp: 'Optional, helps AI understand through examples',
    outputTemplate: 'Output Template',
    outputTemplatePlaceholder: '## Review Report\n- File: {{filename}}\n- Issues: {{issues}}',
  ...
  webContainer: {
    ...
    startupConfigHelp: 'Select subdirectory and script to support monorepo or multi-app directory structures.',
  ...
  workflowEditor: {
    ...
    clickCanvasNode: 'Click on a node in the canvas or add a new node from the right',
    kind: 'Type',
    role: 'Role',
    ...
    templatePlaceholder: 'Custom prompt template, use {{outputKey}} to reference upstream output...',
  ...
  customWorkflowManager: {
    ...
    // Delete dialog
    confirmDelete: 'Confirm Delete',
    deleteConfirmMessage: 'Are you sure you want to delete workflow "{name}"? This action cannot be undone.',
    cancel: 'Cancel',
    delete: 'Delete',
    // Footer
  ...
  workflowEditorDialog: {
    ...
    workflow: 'Workflow',
    // Confirm dialog
    unsavedChangesConfirm: 'You have unsaved changes. Are you sure you want to switch templates?',
    // Status
    valid: 'Valid',
    errors: '{count} errors',
    // Actions
  ...
  session: {
    ...
    conversationSwitcher: {
      deleteConfirm: 'Are you sure you want to delete this workspace cache? All file caches, pending syncs, and undo records will be deleted.',
  ...
  pendingSync: {
    ...
    failed: 'failed',
    skipped: 'skipped',
    pendingChangesWillBeWritten: 'Pending changes will be written to the real filesystem. Please make sure you have selected the correct project folder.',
  },
  ...
  conversation: {
    ...
    regenerateConfirmMessage: 'Are you sure you want to resend this message? The current reply will be replaced.',
    ...
    tokenBudget: 'Effective input budget {effectiveBudget} = Total limit {modelMaxTokens} - Reserve {reserveTokens}',
    // Empty state
    empty: {
    ...
    usage: {
      ...
      tokenUsage: 'Input {promptTokens} + Output {completionTokens} = {totalTokens} tokens',
    },
  },
  ...
  conversationStorage: {
    ...
    cleanupHelpText: 'Conversation records will not be deleted. They will be reloaded from disk on next access.',
    canceling: 'Cancel',
    ...
    cleanupOldDescription: 'Cleanup old conversations file cache to free up space',
    cleanupFileCache: 'Cleanup File Cache',
    cleanupFileCacheHelp: 'Only cleans file cache, does not affect conversation records',
  },
  ...
  offlineQueue: {
    ...
    tasksSavedAutomatically: 'Tasks are automatically saved to queue when network is interrupted',
  },
  ...
  errorBoundary: {
    ...
    componentRenderError: 'An error occurred while rendering this component. This may be a temporary issue, please try refreshing the page.',
  ...
  fileTree: {
    ...
    emptyStateDescription: 'File changes will appear here in pure OPFS sandbox mode',
  ...
  sidebar: {
    ...
    emptyStateNoWorkspace: 'No workspace for this project yet. A workspace will be automatically created when you start your first conversation.',
    ...
    snapshotList: {
      ...
      switchPartial: 'Switch to snapshot not fully successful ({failedSnapshotId}), {count} files still not restored',
      switchFailed: 'Switch failed and auto recovery not fully successful, please manually check snapshot status',
      switchFailedWithCount: 'Switch to latest not fully successful, {count} files still not restored',
      ...
      confirmClearMessage: 'Are you sure you want to clear all snapshots for this project? This cannot be undone.',
      confirmDeleteTitle: 'Confirm Delete',
      confirmDeleteMessage: 'Are you sure you want to delete this snapshot? This cannot be undone.',
      approved: 'Approved',
      committed: 'Committed',
      draft: 'Draft',
      rolledBack: 'Rolled Back',
    ...
    snapshotApproval: {
      ...
      description: 'Will approve <span class="font-semibold">{count}</span> changes and create a snapshot record.',
      summaryLabel: 'Snapshot Description',
      generateAI: 'AI Generate',
      generating: 'Generating...',
      summaryPlaceholder: 'Enter snapshot description (multi-line, first line can be used as title)',
    ...
    confirmClearWorkspace: 'Clear all workspace for current project? This cannot be undone.',
  ...
  workflow: {
    label: 'Workflow',
    description: 'Multi-step AI collaboration with automatic planning, creation, and review.',
