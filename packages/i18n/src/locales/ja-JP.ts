export const jaJP = {
  ...
  app: {
    ...
    // App toast messages
    resetDatabaseFailed: 'データベースのリセットに失敗しました。ページを手動で更新してください',
    localDataCleared: 'ローカルデータが消去されました。最初からやり直せます',
    clearFailedCloseOtherTabs: '消去に失敗しました：まずこのアプリの他のタブ/ウィンドウを閉じてから再試行してください',
    clearLocalDataFailed: 'ローカルデータの消去に失敗しました',
    storageInitError: 'ストレージの初期化エラー',
    projectNotFound: 'プロジェクトが見つからないか、削除されました',
    switchProjectFailed: 'プロジェクトの切り替えに失敗しました。しばらくしてから再試行してください',
    noWorkspaceInProject: '現在のプロジェクトにはワークスペースがありません',
    projectCreated: 'プロジェクト「{name}」が作成されました',
    projectCreatedButSwitchFailed: 'プロジェクトは作成されましたが、切り替えに失敗しました。手動で再試行してください',
    createProjectFailed: 'プロジェクトの作成に失敗しました。しばらくしてから再試行してください',
    ...
    archiveFailed: 'アーカイブに失敗しました。しばらくしてから再試行してください',
    unarchiveFailed: 'アーカイブ解除に失敗しました。しばらくしてから再試行してください',
    ...
    databaseHandleInvalidExplanation: 'ブラウザタブが休止状態になると、データベースファイルハンドルが無効になります。これは通常のブラウザ動作です。',
    ifJustClearedData: '「データ消去」を実行したばかりの場合は、まず同じオリジンの他のタブ/ウィンドウを閉じてから、このページを更新してください。',
    yourDataIsSafe: '会話データは安全です！',
    dataStoredInOPFS: 'データはブラウザのOPFSに保存されており、一時的にアクセスできないだけです。',
    willAutoRecoverAfterRefresh: 'ページを更新すると、データベース接続は自動的に回復します。',
    refreshPage: 'ページを更新',
    cannotCloseDialog: 'このダイアログは閉じられません - 上のボタンをクリックしてページを更新してください',
    databaseInitFailed: 'データベースの初期化に失敗しました',
    databaseResetExplanation: 'これはデータベースの破損または移行の失敗による可能性があります。データベースをリセットすると、すべてのデータがクリアされ再作成されます。',
  ...
  settings: {
    ...
    syncPanel: {
      ...
      encryptionNotice: 'セッションデータはアップロード前に暗号化されます。サーバーは暗号化されたデータのみを保存し、元のコンテンツにアクセスできません。',
      ...
      decryptionFailed: '復号化に失敗しました、データが破損している可能性があります',
      ...
      confirmDelete: 'この同期セッションを削除してもよろしいですか？この操作は元に戻せません。',
      crossDeviceSync: 'デバイス間同期',
      syncDescription: '現在のセッションをクラウドに同期するか、クラウドからセッションをダウンロードします。エンドツーエンド暗号化をサポートし、暗号化されたデータのみが保存されます。',
      loading: '読み込み中...',
      close: '閉じる',
      ...
      conflictResolution: {
        ...
        keepNativeDescription: 'ファイルシステムの元のバージョンを保持し、OPFS への変更を破棄',
        ...
        binaryFilePreview: '[{source} バージョンは画像またはバイナリファイルです',
        noReadableContent: '[{source} バージョンに読み取り可能なテキストコンテンツがありません',
        emptyFile: '[{source} バージョンは空のファイルです',
        contentTruncated: '...[コンテンツが長すぎます。{charCount} 文字を truncation]',
        whyConflict: 'なぜ衝突が発生しましたか？',
        conflictExplanation: 'OPFS のファイルはローカルファイルシステムでも変更されました。',
        ifKeepNativeExists: '「ローカルバージョンを保持」を選択すると、OPFS への変更が破棄されます。',
        ifKeepNativeNotExists: 'ローカルファイルが存在しません。「ローカルバージョンを保持」を選択すると、このファイルは削除されます。',
      ...
      syncPreview: {
        ...
        emptyStateDescription: 'Pythonコード実行後に検出されたファイルシステム変更がここに表示されます。変更の詳細をプレビューし、承認または拒否を選択できます。',
      ...
      fileChangeList: {
        ...
        noChangesDescription: 'Python実行後にファイルシステムの変更は検出されませんでした',
        added: '追加',
        modified: '変更',
        deleted: '削除',
      ...
      fileDiffViewer: {
        ...
        selectFileHint: '左側のリストからファイルを選択して、バージョンと現在のファイルの差分を表示',
        ...
        binaryContent: 'バイナリ内容はテキストレベルの差分をサポートしていません。ファイルをダウンロードするか、専用バイナリ比較ツールを使用してください。',
        ...
        close: '閉じる',
        // AI review prompt
        reviewPromptIntro: '以下のファイルスナップショットをレビューして修正提案をください：',
        file: 'ファイル',
        changeType: '変更タイプ',
        snapshot: 'スナップショット',
        recordedAt: '記録時間',
        ...
        conversationRunning: '現在の会話は実行中です。後でもう一度お試しください',
        reviewConversation: '変更レビュー',
        // Error messages
        loadFailedError: 'ファイルの読み込みに失敗しました',
        cannotReadNativeContent: 'ネイティブファイル内容を表示するにはプロジェクトディレクトリを選択してください',
    ...
    pendingSyncPanel: {
      ...
      confirmRejectMessage: 'すべての変更を拒否してもよろしいですか？この操作は元に戻せません。',
      cancel: 'キャンセル',
      confirmReject: '拒否を確認',
      reviewSuccess: 'レビュー成功！',
      rejectedAllSuccess: 'すべての変更が拒否されました',
      rejectedCountWithFailure: '{successCount} 件の変更を拒否しました。{failedCount} 件はローカルファイルのベースラインが不足しているためリストに残っています',
      rejectChangeFailed: '変更の拒否に失敗しました。後でもう一度お試しください',
      ...
      onlySyncWithLocalDir: 'ローカルディレクトリがある場合にのみディスクに同期',
      syncSuccessMarkSnapshot: '同期成功后、スナップショットを同期済みとしてマーク',
      ...
      conversationRunningPleaseWait: '現在の会話は実行中です。しばらくしてから再試行してください',
    ...
    toast: {
      ...
      providerNameRequired: 'プロバイダー名、Base URL、モデル名を入力してください',
    ...
    modelSelection: {
      ...
      customModelHint: '有効にすると任意のモデル名を入力でき、新しくリリースされたモデルに最適です',
    },
  ...
  welcome: {
    ...
    apiKeyRequiredHint: 'まずモデル設定で API Key を構成してから会話を始めてください',
  ...
  skillEditor: {
    ...
    skillContent: 'スキル内容',
    instruction: '指示',
    instructionPlaceholder: 'あなたはコードレビュー専門家です。ユーザーにコードレビューを求めた時：\n1. 型安全性を分析\n2. パフォーマンスの問題を確認\n3. 可読性を評価',
    exampleDialog: '例会話',
    exampleDialogPlaceholder: 'ユーザー：「このコンポーネントをレビュー帮我」\nAI：「確認します...」',
    exampleDialogHelp: 'オプション、例を提供してAIの理解を助ける',
    outputTemplate: '出力テンプレート',
    outputTemplatePlaceholder: '## レビュー報告\n- ファイル：{{filename}}\n- 問題：{{issues}}',
  ...
  webContainer: {
    ...
    // Config section
    startupConfig: '起動設定',
    startupConfigHelp: 'モノレポまたはマルチアプリディレクトリ構造をサポートするためにサブディレクトリとスクリプトを選択できます。',
    directorySelect: 'ディレクトリ',
    selectDirectory: 'ディレクトリを選択',
    currentStartupDir: '現在の起動ディレクトリ',
    dirChangeRequiresRestart: 'ディレクトリを変更すると再起動または再起動才会生效',
    ...
    copyLogsFailed: 'ログのコピーに失敗しました，ブラウザの権限を確認してください',
  },
  ...
  workflowEditor: {
    ...
    clickCanvasNode: 'キャンバスのノードをクリックするか、右側から新しいノードを追加',
    kind: 'タイプ',
    role: '役割',
    outputKey: '出力キー',
    ...
    templatePlaceholder: 'カスタムプロンプトテンプレート、{{outputKey}} を使用してアップストリーム出力を参照...',
    ...
    createOrOpenWorkflow: '新しいワークフローを作成するか、既存のワークフローを開く',
  ...
  customWorkflowManager: {
    ...
    clickToCreateFirst: '「ワークフローを作成」をクリックして最初のワークフローを作成してください',
    // Domain labels
    generic: '汎用',
    novel: '小説作成',
    video: '動画スクリプト',
    ...
    // Delete dialog
    confirmDelete: '削除の確認',
    deleteConfirmMessage: 'ワークフロー "{name}" を削除してもよろしいですか？この操作は元に戻せません。',
    cancel: 'キャンセル',
    delete: '削除',
    // Footer
  ...
  workflowEditorDialog: {
    ...
    workflow: 'ワークフロー',
    // Confirm dialog
    unsavedChangesConfirm: '保存されていない変更があります。テンプレートを切り替えますか？',
    // Status
    valid: '有効',
    errors: '{count} 件のエラー',
    // Actions
  ...
  session: {
    ...
    conversationSwitcher: {
      deleteConfirm: 'このワークスペースのキャッシュを削除してもよろしいですか？すべてのファイルキャッシュ、保留中の同期、取消記録が削除されます。',
  ...
  standalonePreview: {
    ...
    refreshed: '更新済み',
    refresh: '更新',
    inspectorEnabled: 'インスペクターを有効化 - ページ要素をクリックして情報をコピー',
  ...
  pendingSync: {
    ...
    failed: '失敗',
    skipped: 'スキップ',
    pendingChangesWillBeWritten: '保留中の変更は実際のファイルシステムに書き込まれます。正しいプロジェクトフォルダが選択されていることを確認してください。',
  },
  ...
  conversation: {
    ...
    toolCall: 'ツール呼び出し',
    regenerate: '再生成',
    regenerateConfirmMessage: 'このメッセージを再送信してもよろしいですか？現在の返信は置き換えられます。',
    ...
    tokenBudget: '有効な入力予算 {effectiveBudget} = 上限 {modelMaxTokens} - 予約 {reserveTokens}',
    empty: {
      title: '新しい会話を開始',
    ...
    usage: {
      ...
      nearLimit: '上限に近い',
      comfortable: '余裕あり',
      tokenUsage: '入力 {promptTokens} + 出力 {completionTokens} = {totalTokens} tokens',
    },
  },
  ...
  conversationStorage: {
    ...
    cleanupSuccess: '{count}件の会話ファイルキャッシュをクリアし、{size}を解放しました',
    ...
    cleanupHelpText: '会話記録は削除されません。次回ファイルにアクセス時にディスクから再読み込みされます。',
    canceling: 'キャンセル',
    cleaning: 'クリア中...',
    ...
    browserQuota: '(ブラウザ配额)',
    loading: '読み込み中...',
    quotaExplanation: '配额はブラウザ允許的上限であり、実際の空き容量とは異なります。実際の容量を超える書き込みはエラーになります。',
    ...
    cleanupFileCacheHelp: 'ファイルキャッシュのみをクリアし、会話記録には影響しません',
  },
  ...
  offlineQueue: {
    ...
    tasksSavedAutomatically: 'ネットワーク中断時はタスクが自動的にキューに保存されます',
  },
  ...
  errorBoundary: {
    ...
    componentRenderError: 'コンポーネントのレンダリング中にエラーが発生しました。一時的な問題の場合は、ページを更新してください。',
    errorDetails: 'エラーの詳細',
    retry: '再試行',
  ...
  filePreview: {
    ...
    conflict: '競合',
    diskFileNewer: 'ディスクファイルがOPFSより新しいです。競合がある可能性があります',
  ...
  fileTree: {
    ...
    emptyStateDescription: 'Pure OPFS サンドボックスモードでは、ファイルの変更がここに表示されます',
    draftFiles: '下書きファイル',
  ...
  sidebar: {
    ...
    emptyStateNoWorkspace: 'このプロジェクトのワークスペースはまだありません。最初の会話を開始すると、ワークスペースが自動的に作成されます。',
    ...
    snapshotList: {
      ...
      switchPartial: 'スナップショットへの切り替えが完全成功しませんでした（失敗スナップショット {failedSnapshotId}）、{count}件の変更がまだ元に戻っていません',
      switchFailed: '切り替えが失敗し自動回復も完全成功しませんでした。手動でスナップショット状況を確認してください',
      switchFailedWithCount: '最新への切り替えが完全成功しませんでした、{count}件の変更がまだ元に戻っていません',
      ...
      confirmClearMessage: 'このプロジェクトのすべてのスナップショットをクリアしますか？この操作は元に戻せません。',
      confirmDeleteTitle: '削除の確認',
      confirmDeleteMessage: 'このスナップショットを削除しますか？この操作は元に戻せません。',
      approved: '承認済み',
      committed: 'コミット済み',
      draft: '下書き',
      rolledBack: 'ロールバック済み',
    ...
    snapshotApproval: {
      title: 'スナップショットを作成',
      description: '<span class="font-semibold">{count}</span>件の変更を承認し、スナップショットレコードを作成します。',
      summaryLabel: 'スナップショット説明',
      generateAI: 'AI 生成',
      generating: '生成中...',
      summaryPlaceholder: 'スナップショットの説明を入力（複数行可、最初の一行をタイトルとして使用）',
    ...
    confirmClearWorkspace: '現在のプロジェクトのすべてのワークスペースをクリアしますか？この操作は元に戻せません。',
