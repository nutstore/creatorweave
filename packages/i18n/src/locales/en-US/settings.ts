export const settings = {
    ...
    webMCPExtensionRequiredHint: "WebMCP requires the CreatorWeave browser extension to be installed and active. Click the button below to start the installation.",
