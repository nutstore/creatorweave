export const settings = {
    ...
    syncPanel: {
      ...
      syncPreview: {
        emptyStateTitle: "AI modified files — waiting for your review",
        emptyStateDescription:
          "File changes from AI code execution are stored in the browser only and won't affect your local files until you approve them. Preview the changes here, then click 'Confirm' to save them to disk.",
        ...
        step3Title: "Confirm or Discard",
        step3Desc: "Confirm to save changes to your local files",
        ...
        syncFailedCount: "{failed} files failed to save{conflicts}",
      },
    ...
    pendingSyncPanel: {
      ...
      reviewSuccess: "Saved to local files!",
      rejectedAllSuccess: "All changes discarded",
      ...
      syncFailed: "Failed to save, please retry",
      ...
      onlySyncWithLocalDir: "Only save to disk when a local directory is selected",
      syncSuccessMarkSnapshot: "Mark record as synced after successful save",
      ...
      pendingChanges: "Changes to Confirm",
