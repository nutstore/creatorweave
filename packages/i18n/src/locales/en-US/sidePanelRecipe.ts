...
export const sidePanelRecipe = {
  ...
  enabling: "Enabling…",
  notNow: "Not now",
  enabledToast: "{name} enabled — the page will reload to activate the tools",
  enableFailedToast: "Failed to enable. Please make sure the extension is up to date and try again.",
}
