...
export const settings = {
    ...
    syncPanel: {
      ...
      syncPreview: {
        emptyStateTitle: "AI 修改了文件，等你确认",
        emptyStateDescription:
          "AI 执行代码后产生的文件修改会暂存在浏览器中，不会直接写入你的本地文件。你可以在这里查看修改内容，确认无误后点击「确认保存」，修改才会真正保存到本地磁盘。",
        step1Title: "AI 修改了文件",
        step1Desc: "AI 在对话中执行代码，修改或创建了文件",
        step2Title: "查看修改内容",
        step2Desc: "在这里预览 AI 具体改了什么",
        step3Title: "确认或放弃",
        step3Desc: "确认无误后点击保存，修改才会写入本地文件",
        ...
        syncFailedCount: "{failed} 个文件保存失败{conflicts}"
      },
    ...
    pendingSyncPanel: {
      ...
      confirmRejectMessage: "确定要拒绝所选变更吗？此操作无法撤销。",
      cancel: "取消",
      confirmReject: "确认拒绝",
      reviewSuccess: "已保存到本地文件！",
      ...
      onlySyncWithLocalDir: "仅在已选择本地目录时才能保存到磁盘",
      syncSuccessMarkSnapshot: "保存成功后标记记录为已同步",
    ...
    notifications: {
      ...
      testButton: "发送测试",
      testTitle: "CreatorWeave Agent · 测试",
