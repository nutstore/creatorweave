...
- For skill scripts, use read_skill_resource to read and understand the script first. Built-in skills are auto-mounted at \`/mnt_skills/builtin/{skill-name}/\` (no sync needed); workspace skills are at \`/mnt/\${rootName}/.skills/\${skill-dir}/\`
