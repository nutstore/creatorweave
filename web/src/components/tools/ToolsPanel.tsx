    ...
    <>
      ...
      <div className="fixed right-0 top-0 z-50 flex h-full w-full max-w-md flex-col bg-white shadow-xl">
        ...
        <div className="flex items-center justify-between border-b border-neutral-200 px-6 py-4">
          <div>
            <h2 className="text-lg font-semibold text-neutral-900">Available Tools</h2>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          {filteredCategories.length === 0 ? (
            <div className="py-8 text-center">
              <p className="text-neutral-500">No tools found matching "{searchQuery}"</p>
            </div>
          ) : (
        ...
        >
          ...
          <div className="flex items-center justify-between border-b border-neutral-200 px-6 py-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-mono font-semibold text-neutral-900">{tool.name}</h3>
            </div>
            <button
              onClick={onClose}
              className="rounded-lg p-2 text-neutral-400 transition-colors hover:bg-neutral-100 hover:text-neutral-600"
          ...
          <div className="flex-1 overflow-y-auto px-6 py-4">
            {/* Description */}
            <div className="mb-6">
              <h4 className="mb-2 text-sm font-medium text-neutral-700">Description</h4>
            ...
            {Object.keys(tool.parameters).length > 0 && (
              <div>
                <h4 className="mb-3 text-sm font-medium text-neutral-700">Parameters</h4>
