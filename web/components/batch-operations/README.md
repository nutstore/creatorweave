...
**File:** `web/agent/tools/batch-operations.tool.ts`
...
**File:** `web/agent/tools/__tests__/batch-operations.tool.test.ts`
...
**File:** `web/components/batch-operations/BatchOperationsPanel.tsx`
...
**File:** `web/agent/tool-registry.ts` (updated)
...
- `web/agent/tool-registry.ts` - Tool registration
- `web/store/opfs.store.ts` - OPFS cache integration
- `web/undo/undo-manager.ts` - Undo/redo support
- `web/services/traversal.service.ts` - File system traversal
